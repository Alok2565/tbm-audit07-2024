...
<body style="background-color: #022759;">
    <h1>{{ $forgotNicEmailLink['title'] }}</h1>
    <p>{{ $forgotNicEmailLink['body'] }}</p>
    <div class="container">
        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            ...
            <p><a href="{{ url('nic/reset-password?id='.encrypt($forgotNicEmailLink['email'])) }}" class="link-reset-password button" style="color:#ffffff;">Reset password</a></p>
