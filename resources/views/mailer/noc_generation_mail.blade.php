...
<body style="background-color: #022759;">
    <h1>{{ $nocGeneration['title'] }}</h1>
    <p>{{ $nocGeneration['body'] }}</p>
    <div class="container">
        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            <h3 class="from-name" style="padding: 5px;">Dear Applicant,</h3>
            <p style="padding-top: 10px; font-size:15px;">The application with Application number <strong>{{ $nocGeneration['application_number'] }}</strong> has been duly considered at ICMR.</p>
