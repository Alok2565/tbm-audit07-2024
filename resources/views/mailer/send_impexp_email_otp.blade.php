...
<body style="background-color: #022759;">
    <h1>{{ $ImpExpsendEmailOtp['title'] }}</h1>
    <p>{{ $ImpExpsendEmailOtp['body'] }}</p>
    <div class="container">

        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            <h3 class="from-name" style="padding: 5px;">One Time Password</h3>
            <h3 class="wel-text" style="padding-top: 10px; font-size:15px;">{{ $ImpExpsendEmailOtp['ImpEXPEmailOtp'] }}</h3>
            {{-- <p style="padding-top 10px; font-size:15px;"><a href="{{ url('icmr/email-verification?id='.encrypt($ImpExpsendEmailOtp['ImpEXPEmailOtp'])) }}" class="link-generate-password" style="color:#022759;">{{ url('icmr/email-verification')}}</a></p> --}}
