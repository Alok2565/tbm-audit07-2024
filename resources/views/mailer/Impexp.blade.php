...
<body>
    ...
    <p>To Generate Password. Please clink on the Link.</p>
    <p><a href="{{ url('imp-exp/generate-password?id='.encrypt($mailData['iec_code'])) }}" class="link-generate-password">{{ url('imp-exp/generate-password') }}</a></p>
    <p>Thank you</p>
</body>
</html> --}}
...
<body style="background-color: #022759;">
    ...
    <div class="container">
        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            ...
            <p><a href="{{ url('imp-exp/generate-password?id='.encrypt($mailData['iec_code'])) }}" class="link-generate-password" style="color:#022759;">{{ url('imp-exp/generate-password') }}</a></p>
