...
<body style="background-color: #022759;">
    <h1>{{ $IcmrsendEmailOtp['title'] }}</h1>
    <p>{{ $IcmrsendEmailOtp['body'] }}</p>
    <div class="container">

        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            <h3 class="from-name" style="padding: 5px;">One Time Password</h3>
            <h3 class="wel-text" style="padding-top: 10px; font-size:15px;">{{ $IcmrsendEmailOtp['IcmrEmailOtp'] }}</h3>
            {{-- <p style="padding-top 10px; font-size:15px;"><a href="{{ url('icmr/email-verification?id='.encrypt($IcmrsendEmailOtp['IcmrEmailOtp'])) }}" class="link-generate-password" style="color:#022759;">{{ url('icmr/email-verification')}}</a></p> --}}
