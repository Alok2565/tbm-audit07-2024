...
<body style="background-color: #022759;">
    <h1>{{ $forgotEmailLink['title'] }}</h1>
    <p>{{ $forgotEmailLink['body'] }}</p>
    <div class="container">
        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            ...
            <p><a href="{{ url('imp-exp/reset-password?id='.encrypt($forgotEmailLink['iec_code'])) }}" class="link-reset-password button" style="color:#ffffff;">Reset password</a></p>
