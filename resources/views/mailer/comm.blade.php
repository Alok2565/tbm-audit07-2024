    ...
    <div class="container">
        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            ...
            <p style="padding-top: 10px; font-size:15px;">You may kindly generate the password to login into your account for submission of THBM application at the
                THBM portal.</p>
            <p class="text-white">To Generate Password, please click on the link below.</p>
            <p style="padding-top 10px; font-size:15px;"><a href="{{ url('committee/generate-password?id=' . encrypt($mailData['email'])) }}"
                    class="link-generate-password" style="color:#022759;">{{ url('committee/generate-passwordicmr') }}</a></p>
