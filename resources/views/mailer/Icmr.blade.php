...
<body>
    ...
    <p><a href="{{ url('icmr/generate-password?id='.encrypt($mailData['email'])) }}" class="link-generate-password">{{ url('icmr/generate-passwordicmr') }}</a></p>
    <p>Thank you</p>
</body>
</html> --}}
...
<body style="background-color: #022759;">
    ...
    <div class="container">
        <div class="mail-text" style="background-color: #ffffff; padding:10px;">
            ...
            <p><a href="{{ url('icmr/generate-password?id='.encrypt($mailData['email'])) }}" class="link-generate-password" style="color:#022759;">{{ url('icmr/generate-passwordicmr') }}</a></p>
