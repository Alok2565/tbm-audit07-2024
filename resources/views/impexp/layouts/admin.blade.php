...
<head>
    ...
    <!-- Datatables css -->
    <link href="{{ asset('public/back/assets/vendor/datatables.net-bs5/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('public/back/assets/vendor/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css') }}"
        rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/back/assets/vendor/datatables.net-fixedcolumns-bs5/css/fixedColumns.bootstrap5.min.css') }}"
        rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/back/assets/vendor/datatables.net-fixedheader-bs5/css/fixedHeader.bootstrap5.min.css') }}"
        rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/back/assets/vendor/datatables.net-buttons-bs5/css/buttons.bootstrap5.min.css') }}"
        rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/back/assets/vendor/datatables.net-select-bs5/css/select.bootstrap5.min.css') }}"
        rel="stylesheet" type="text/css" />
...
$refererHost = parse_url($referer, PHP_URL_HOST);
   ...
   {?>
    ...
    window.location = "{{ url('imp-exp/logoutimpexp') }}";
</script>
  <?php }
 ...
 ?>
    <!-- Begin page -->
    <div class="wrapper">
        @include('impexp.layouts.top_right')
        @include('impexp.layouts.sidebar_nav')
    ...
    <script src="{{ asset('public/back/assets/vendor/datatables.net-fixedcolumns-bs5/js/fixedColumns.bootstrap5.min.js') }}">
    </script>
