...
<section class="mb-5 py-2">
    <div class="container">
        <p class="text-start" style="text-align:center!important;font-size: 17px; font-weight:600; color:#14468C"><strong>Edit IMPORT of Human Samples</strong></p>
...
<section class="exporter-section mt-3">
    <div class="container">
	<form method="POST" action="{{url('imp-exp/updates')}}/{{$Imports->id}}" enctype="multipart/form-data">
	   {{ csrf_field() }}
       <div class="card custom-card">
            <div class="form-card-title text-white">
                <p class="title-items">PART-A: Basic information</p>
            </div>
            <div class="form-card-sub-title text-black">
                <div class="row">
                    <div class="col-md-12">
        ...
        <div class="row mt-3">
            <div class="col-md-4">
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" id="iec_number" name="iec_number" value="{{$Imports->iec_number}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group mt-2">
                    <label for="send_app_name" class="form-label">(ii) Name of the Applicant</label>
                    <input type="text" class="form-control" id="name_of_applicant" name="name_of_applicant" value="{{$Imports->name_of_applicant}}">
                </div>
            </div>
			<div class="col-md-4">
                <div class="form-group mt-2">
                    <label for="send_app_design" class="form-label">(iii) Name of the Designation</label>
                    <input type="text" class="form-control" id="name_of_designation" name="name_of_designation" value="{{$Imports->name_of_designation}}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
			<div class="col-md-4">
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" id="address_company" name="address_company" value="{{$Imports->address_company}}">
                </div>
            </div>
			...
			<div class="row mt-2">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <div class="form-check form-check-inline custom-no">
                                <input class="form-check-input" type="radio"
                                    ...
                                    value="{{$Imports->company_denied_import}}"/>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <textarea name="company_denied_import[]" id="wirtetext_yes" maxlength="100" cols="45" rows="2" max="100" style="border:1px solid #ddd; border-radius: 5px !important; display:none;">{{$Imports->company_denied_import}}</textarea>
                        </div>
                    </div>           
               </div><!--end main row-->			
			</div>
		...
		<div class="row mt-3">
            <div class="col-md-4">
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" id="name_of_sender" name="name_of_sender" value="{{$Imports->name_of_sender}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group mt-2">
                    <label for="send_app_name" class="form-label">(ii) Designation of the Sender</label>
                    <input type="text" class="form-control" id="designation_of_sender" name="designation_of_sender" value="{{$Imports->designation_of_sender}}">
                </div>
            </div>
			 <div class="col-md-4">
                <div class="form-group mt-2">
                    <label for="send_app_name" class="form-label">(iii) Address of the Company/Institution</label>
                    <input type="text" class="form-control" id="address_of_company" name="address_of_company" value="{{$Imports->address_of_company}}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" id="hs_code" name="hs_code" value="{{$Imports->hs_code}}">
                </div>
            </div>
            <div class="col-md-8">
			<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-6">
			<div class="form-group mt-2">
			<input type="text" class="form-control" id="Quantity_import_num" name="Quantity_import_num" value="{{$Imports->Quantity_import_num}}">
			</div>
			</div>
			<div class="col-md-6">
			<div class="form-group mt-2">
			<input type="text" class="form-control" id="Quantity_import_vol" name="Quantity_import_vol" value="{{$Imports->Quantity_import_vol}}">
			</div>
			</div>
             </div>
            </div>
		...
		<div class="row">
			...
			<div class="col-md-6 pt-4">
			    <textarea name="purpose_end_use[]" id="enduser_yes" maxlength="100" cols="70" rows="3"max="100" placeholder="Max 100 Words" style="border:1px solid #ddd; border-radius: 5px !important; display:none;"></textarea> 
            </div>
        </div>
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            <textarea name="biosafety_concerns[]" id="wirtebiosafety_yes" maxlength="100" cols="35" rows="3"
                                max="100" placeholder="Max 100 Words" style="border:1px solid #ddd; border-radius: 5px !important; display:none;">
							</textarea>
                        </div>
                    </div>            
               </div>	
		...
		<div class="row mt-3">
            ...
            <div class="col-md-6">
				...
				@if ($errors->has('biological_material'))
				   <span class="text-danger text-left">{{ $errors->first('biological_material') }}</span>
			   @endif
            </div>
        </div>
		<div class="card custom-card mt-4">
		...
		<div class="row" style="margin: 3px;">
			...
			<div class="col-md-7">
               <p>I certify that the information provided in this  request form is true and correct to the best of my
				...
				purpose of <input type="text" class="partc" name="purpose_of" value="{{$Imports->purpose_of}}">  only, as stated in the application.</p> 
              <p>This is to certify that the samples referred to herein being sent me for analyses/experimentation, as
				...
				utilized for the purpose of <input type="text" class="partc" name="purpose_of_one" value="{{$Imports->purpose_of_one}}">  only,
		...
		<div class="row mt-4" style="padding: 5px; margin: 3px;border:1px solid #0000004a;">
              ...
              <input type="text" style="width:280px;" class="float-start form-control mt-3" name="signature" value="{{$Imports->signature}}">
			  <p>Signature</p>
			  ...
			  <div class="row">
			      <div class="col-md-6">
				     <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$Imports->name}}" name="name">
                     </div>
				  </div>
				  <div class="col-md-6">
				       <div class="form-group">
                           <label for="impexp_iec_code" class="form-label">Designation:</label>
                           <input type="text" class="form-control" value="{{$Imports->designation}}" name="designation">
                       </div>
				  </div>
			  </div>
			  <div class="row">
			      <div class="col-md-6">
				      <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="{{$Imports->address}}" name="address">
                       </div>
				  </div>
				  <div class="col-md-6">
				       <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="{{$Imports->dates}}" id="dates" name="dates">
                       </div>
				  </div>
			  </div>
        ...
        <div class="col-md-12 mt-3">
            <button type="submit" class="btn btn-primary mb-3" name="submit" id="btnSubmit" value="submit">Update</button>
