...
<input type="hidden" name="declaration_letter_draft" id="declaration_letter_draft" value="">
                                    ...
                                    <div class="col-md-7">
                                            <div class="upload-download mt-2">
                                                ...
                                                <a href="{{ asset('public/assets/backend/images/exporter/declaration-by-recipient-of-samples.docx') }}" class="download-letter-item" target="_blank"><button type="button" class="btn btn-primary mt-1">Download</button></a>
                                    </div>
