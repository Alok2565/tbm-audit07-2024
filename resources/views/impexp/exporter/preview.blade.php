                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ul class="breadcrumb m-0">
                            ...
                            <?php if($url_key == 1){
                                    $url = 'imp-exp/exporter';
                                    }
                                    else if($url_key == 2){
                                    $url = 'imp-exp/reject-exporter';
                                    } else if($url_key == 3){
                                        $url = 'imp-exp/pending-exporter';
                                        }
                                    ?>
                                    <button class="btn btn-primary float-end">
                                    <a class="float-end text-white" href="
                                    {{ url($url) }}" style="font-weight:600;">Back to
                                    Lists</a>
                                    </button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{-- <a href="{{ asset('media/exporter/'.$export_data->upload_comp_institute_denied_export) }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        ...
                                                        <a href="{{ url('imp-exp/exporter/viewDocument') }}/{{ \Illuminate\Support\Facades\Crypt::encrypt('public/media/exporter/'.$export_data->upload_comp_institute_denied_export.'key'.Session::get('key')) }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        </a>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            {{$export_data->end_user_receiving_party_yes_no}}
                                                    @php
                                                    if(!empty($export_data->end_user_receiving_party_yes_no) && $export_data->end_user_receiving_party_yes_no =="Yes")
                                                    {
                                                    @endphp
                                                <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="natural_biomaterial_exported[]" id="TextNaturalbiomateria" class="mt-2" maxlength="100"
                                            ...
                                            style="border:1px solid #ddd; border-radius: 5px !important; {{($export_data->natural_biomaterial_exported_any_tissue_details != '')? '':'display: none;'}}" readonly>{{isset($export_data->natural_biomaterial_exported_any_tissue_details)? $export_data->natural_biomaterial_exported_any_tissue_details:''}}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @endphp
                                        <div class="col-md-8">
                                            <div class="form-group">
                                            <ul>
                                            <li>{{(!empty($export_data->purpose_sample_store))?$export_data->purpose_sample_store:''}}</li>
                                    </ul><br>


                                                <textarea name="samples_used_research_analysis[]" readonly id="wirteSamplesAnalysis" maxlength="100" cols="40" rows="2" max="100" placeholder="Specify Details" style="border:1px solid #ddd; border-radius: 5px !important; {{ (!empty($export_data->purpose_sample_store) && $export_data->purpose_sample_store == 'Further analysis')? '':'display:none'; }}">{{ ($export_data->samples_used_research_analysis_details != '')? $export_data->samples_used_research_analysis_details:''; }}</textarea>
                                        <!-- @php
                                        if(!empty($d)){
                                            foreach($d as $value4){
                                                @endphp
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{ $export_data->biomaterial_micro_organisms_approval}}
                                        ...
                                        <div class="input-group" style="width:50%; {{ ($export_data->biomaterial_micro_organisms_approval_file != '')? '':'display:none;' }}">
                                            {{-- <a href="{{ asset('media/exporter/'.$export_data->biomaterial_micro_organisms_approval_file) }}" target="_blank"><label class="form-lable"><strong>Click to View</strong></label>
                                                        </a> --}}
                                                        <a href="{{ url('imp-exp/exporter/viewDocument') }}/{{ \Illuminate\Support\Facades\Crypt::encrypt('public/media/exporter/'.$export_data->biomaterial_micro_organisms_approval_file.'key'.Session::get('key')) }}" target="_blank"><label class="form-lable"><strong>Click to View</strong></label>
                                                        </a>
                                        </div>
                                    ...
                                    {{ $export_data->ibsc_rcgm_approval_applicable }}
                                        ...
                                        <div class="input-group" style="width:50%; {{ ($export_data->ibsc_rcgm_approval_applicable_file != '')? '':'display:none;' }}">
                                            ...
                                            {{-- <a href="{{ asset('media/exporter/'.$export_data->ibsc_rcgm_approval_applicable_file) }}" target="_blank"><label class="form-lable"><strong>Click to View </strong></label>
                                                        ...
                                                        <a href="{{ url('imp-exp/exporter/viewDocument') }}/{{ \Illuminate\Support\Facades\Crypt::encrypt('public/media/exporter/'.$export_data->ibsc_rcgm_approval_applicable_file.'key'.Session::get('key')) }}" target="_blank"><label class="form-lable"><strong>Click to View </strong></label>
                                                        </a>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="m-2">  <label class="m-2 form-check-label" for="invalidCheck"> <input type="checkbox" class="form-check-input" id="invalidCheck" checked style="width:20px; height:20px; border: 1px solid #022759"> <span class="text-danger">*</span> I certify that the information provided in this request form is true and
                                        ...
                                        referred to herein will be utilized for the purpose of <strong><span> {{(!empty($export_data->sender_certify_information_provided))? $export_data->sender_certify_information_provided:''}} </span></strong>only, the samples will not be used for any other purposes.</span></label>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group mb-3 m-2">
                                                ...
                                                {{-- <a href="{{ asset('media/exporter/'.$export_data->certified_copy_proforma) }}" target="_blank" style="{{ ($export_data->certified_copy_proforma != '')? '':'display:none;' }}"><label class="form-lable"><strong>View Invoice</strong></label>
                                                        ...
                                                        <a href="{{ url('imp-exp/exporter/viewDocument') }}/{{ \Illuminate\Support\Facades\Crypt::encrypt('public/media/exporter/'.$export_data->certified_copy_proforma.'key'.Session::get('key')) }}" target="_blank" style="{{ ($export_data->certified_copy_proforma != '')? '':'display:none;' }}"><label class="form-lable"><strong>View Invoice</strong></label>
                                                        </a>
                                            </div>
                                        </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-5">
                                            <div class="form-group mb-3 m-2">
                                                ...
                                                {{-- <a href="{{ asset('media/exporter/'.$export_data->declaration_letter) }}" target="_blank" style="{{ ($export_data->declaration_letter != '')? '':'display:none;' }}"><label class="form-lable"><strong>View Letter</strong></label>
                                                        ...
                                                        <a href="{{ url('imp-exp/exporter/viewDocument') }}/{{ \Illuminate\Support\Facades\Crypt::encrypt('public/media/exporter/'.$export_data->declaration_letter.'key'.Session::get('key')) }}" target="_blank" style="{{ ($export_data->declaration_letter != '')? '':'display:none;' }}"><label class="form-lable"><strong>View Letter</strong></label>
                                                        </a>
                                            </div>
                                   ...
                                   <!-- <div class="col-md-7">
                                    ...
                                    <div class="col-md-12 mb-5 m-2">
                                        <p>This is to certify that the samples referred to herein being sent to <b>&nbsp;{{ $export_data->sending_applicant_name }} </b> (Name of Institution) for analyses/investigations will be in the
                                            <br>custody of <b> {{isset($export_data->receving_recipient_name)? $export_data->receving_recipient_name:''}} </b> and I hereby confirm that they will be utilized for the purpose of <b> {{ ($export_data->sender_certify_information_provided != '')? $export_data->sender_certify_information_provided:''}}
