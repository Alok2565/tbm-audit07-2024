                                        ...
                                        <div class="form-group">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    value="Yes" {{(!empty($export_data->denied_export_auth_last_3_years_yes_no) && $export_data->denied_export_auth_last_3_years_yes_no == 'Yes')? 'checked':''}}{{ (old('denied_export_auth_last_3_years_yes_no') == 'Yes')? 'checked' : ''}}/>
                                                <label class="form-check-label" for="inlineRadio1">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="denied_export_auth_last_3_years_yes_no" id="text_no"
                                                    value="No" {{(!empty($export_data->denied_export_auth_last_3_years_yes_no) && $export_data->denied_export_auth_last_3_years_yes_no == 'No')? 'checked':''}}{{ (old('denied_export_auth_last_3_years_yes_no') == 'No')? 'checked' : ''}}/>
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <div class="form-group">
                                                    <textarea name="end_user_receiving_party" value="" id="wirtetextEnd_user_yes" maxlength="100" cols="42"
                                                        ...
                                                        style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->end_user_receiving_party_yes_no) && $export_data->end_user_receiving_party_yes_no == 'Yes') || (old('end_user_receiving_party_yes_no') == 'Yes'))? '':'display:none;'}}">{{(!empty($export_data->end_user_receiving_party))? $export_data->end_user_receiving_party:''}}{{ old('end_user_receiving_party') }}</textarea>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea name="samples_being_exported_details" class="TextsamplesExported" id="TextsamplesExported" maxlength="100" cols="60" rows="2" max="100" placeholder="Add details" style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->samples_being_exported) && $export_data->samples_being_exported == 'Yes') || (old('samples_being_exported') == 'Yes'))? '':'display:none'}};">{{(!empty($export_data->samples_being_exported_details))? $export_data->samples_being_exported_details:''}}{{ old('samples_being_exported_details') }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exported_number" name="exported_number" value="{{!empty($export_data->exported_number)? $export_data->exported_number:''}}{{old('exported_number')}}">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="vol_of_sample_text" name="vol_of_sample_text" value="{{!empty($export_data->vol_of_sample_text)? $export_data->vol_of_sample_text:''}}{{old('vol_of_sample_text')}}">
                                    ...
                                    <label for="repeat_samples_envisaged" class="form-label mt-2"><strong>(vi) Whether repeat export of samples is envisaged?</strong><span class="text-danger">*</span></label>
                                            <div class="form-group mt-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="repeat_samples_envisaged" class="wirteRepeat_export" id="wirteRepeat_export" maxlength="100" cols="60" rows="2" max="100" placeholder="Add details" style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->repeat_samples_envisaged_yes_no) && $export_data->repeat_samples_envisaged_yes_no == 'Yes') || (old('repeat_samples_envisaged_yes_no') == 'Yes'))? '':'display:none'}}">{{(!empty($export_data->repeat_samples_envisaged))? $export_data->repeat_samples_envisaged:''}}{{old('repeat_samples_envisaged')}}</textarea>
                                    ...
                                    <div class="form-group mt-2">
                                     ...
                                     <!-- <br><input type="button" id="purpose_sample_store_button" value="      Please Click to Select     "></button>
                                        <ul id="purpose_sample_store_display" style="display:none">
                                            ...
                                            <label for="purpose_sample_store" class="form-label wirteotherFurther" style="{{((!empty($export_data->purpose_sample_store) && $export_data->purpose_sample_store == 'Further analysis') || old('purpose_sample_store'))? '':'display:none;'}}"><strong>Provide details</strong></label><br>
                                           <textarea name="purpose_sample_store_details" id="wirteotherFurther" class="mt-2" maxlength="100" cols="60" rows="2" max="100" placeholder="Please specify genetic analysis or any other analysis." style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->purpose_sample_store) && $export_data->purpose_sample_store == 'Further analysis') || (old('purpose_sample_store') == 'Further analysis'))? '':'display:none;'}}">{{(!empty($export_data->purpose_sample_store_details))? $export_data->purpose_sample_store_details:''}}{{old('purpose_sample_store')}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" value="{{(!empty($export_data->duration_sample_store))? $export_data->duration_sample_store:''}}{{old('duration_sample_store')}}" name="duration_sample_store" id="duration_sample_store" class="form-control mt-2" placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" value="{{(!empty($export_data->facility_sample_store))? $export_data->facility_sample_store:''}}{{old('facility_sample_store')}}" name="facility_sample_store" id="facility_sample_store" class="form-control mt-2" placeholder="">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="national_security_angle" class="textNationalSecurity" id="textNationalSecurity" maxlength="100" cols="65" rows="2" max="100" placeholder="Add details" style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->national_security_angle_yes_no) && $export_data->national_security_angle_yes_no == 'Yes') || (old('national_security_angle_yes_no') == 'Yes'))? '':'display:none'}}">{{(!empty($export_data->national_security_angle))? $export_data->national_security_angle:''}}{{old('national_security_angle')}}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <a href="{{ asset('media/exporter/'.$export_data->biomaterial_micro_organisms_approval_file) }}" target="_blank"><label class="form-lable" style="{{(($export_data->biomaterial_micro_organisms_approval_file != '') || (old('biomaterial_micro_organisms_approval') == 'Yes'))? '':'display: none;'}}"><strong>View Uploaded documents</strong></label>
                                                        </a>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-check">
                                        ...
                                        {{-- <label class="form-check-label form-label" for="invalidCheck">Agree to terms
                                            ...
                                            <label class="m-2 form-check-label" for="invalidCheck">
                                                <input type="checkbox" class="form-check-input decleration_check" name="icertify" id="decleration_check" style="width:20px; height:20px; border: 1px solid #022759">
                                    ...
                                    <p class="text-black justify-content-between border-bottom mt-3 m-2"> <label class="form-check-label" for="invalidCheck">
                                         <input type="checkbox" class="form-check-input " name="certifythat" id="commercial_check" style="width:20px; height:20px; border: 1px solid #022759">
