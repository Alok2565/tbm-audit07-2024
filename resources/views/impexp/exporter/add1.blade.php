                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" data-placeholder="Select..." name="nature_of_biomaterial_options" id="natural_biomaterial_exported_others">
                                                ...
                                                @endphp
                                                <option value="{{$value2->value}}" {{(!empty($export_data->natural_biomaterial_exported_details) && $export_data->natural_biomaterial_exported_details == $value2->value)? 'selected':''}}@if (old('nature_of_biomaterial_options') == $value2->value) selected="selected" @endif>{{$value2->name}}</option>
                                                @php
                                                }
                                                @endphp
                                            </select>
                                            ...
                                            <textarea class="mt-2" name="natural_biomaterial_exported_details" id="natural_biomaterial_exported_details" maxlength="100" cols="45" rows="2" max="100" placeholder="Add details" style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->nature_of_biomaterial_options) && ($export_data->natural_biomaterial_exported_details == 'Other body fluids' || $export_data->natural_biomaterial_exported_details == 'Any Tissue/Cells' || $export_data->natural_biomaterial_exported_details == 'Others')) || ( old('nature_of_biomaterial_options') == 'Other body fluids' || old('nature_of_biomaterial_options') == 'Any Tissue/Cells' || old('nature_of_biomaterial_options') == 'Others'))? '':'display:none'}}">{{(!empty($export_data->natural_biomaterial_exported_details))? $export_data->natural_biomaterial_exported_details :''}}{{old('natural_biomaterial_exported_details')}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mt-2">
                                        ...
                                        @if($errors->has('sample_collected'))
											...
											@endif
                                            <span class="text-danger" id="value9"></span>
                                        ...
                                        <ul id="where_sample_collected_options_display" style="display:none">
                                            ...
                                            <textarea class="mt-2" name="sample_collected_details" id="TextSampleCollectedwhere" maxlength="100" cols="60" rows="2" max="100" placeholder="Add details" style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->sample_collected) && $export_data->sample_collected == 'Others') || ( old('sample_collected') == 'Others'))? '':'display:none'}}">{{(!empty($export_data->sample_collected_details))? $export_data->sample_collected_details :''}}{{old('sample_collected_details')}}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="sample_collected" class="form-label mt-2 TextsamplesExported" style="{{((!empty($export_data->samples_being_exported) && $export_data->samples_being_exported == 'Yes') || (old('samples_being_exported') == 'Yes'))? '':'display:none'}}"><strong>Provide details</strong></label>
                                    ...
                                    <label for="repeat_samples_envisaged" class="form-label mt-2"><strong>(vi) Whether repeat export of samples is envisaged?</strong></label>
                                            <div class="form-group mt-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="repeat_samples_envisaged" class="wirteRepeat_export" id="wirteRepeat_export" maxlength="100" cols="60" rows="2" max="100" placeholder="Add details" style="border:1px solid #ddd; border-radius: 5px !important; {{((!empty($export_data->repeat_samples_envisaged_yes_no) && $export_data->repeat_samples_envisaged_yes_no == 'Yes') || (old('repeat_samples_envisaged_yes_no') == 'Yes'))? '':'display:none'}}">{{(!empty($export_data->repeat_samples_envisaged))? $export_data->repeat_samples_envisaged:''}}{{old('repat_samples_envisaged')}}</textarea>
                                                </div>
                                                <div class="form-check form-check-inline">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mb-1" data-placeholder="Select..." name="specify_purpose_end_use" id="specify_purpose_end_use_id_others">
                                            <option  value="">Please Select</option>
                                            @php
                                            ...
                                            <div class="form-group">
                                                <select class="form-control research_analysisSelect mb-2" data-placeholder="Select..." name="purpose_sample_store" id="research_analysisSelect" style="display:none;">
                                                    ...
                                                    foreach($weather_sample_used_research_analysis_options as $value4){
                                                      @endphp
                                                      <option value="{{$value4->value}}" {{(!empty($export_data->weather_sample_used_research_analysis_options) && $export_data->weather_sample_used_research_analysis_options == $value5->value)? 'selected':''}}@if (old('weather_sample_used_research_analysis_options') == $value4->value) selected="selected" @endif>{{$value4->value}}</option>
                                                      @php
                                                    }
                                                    @endphp
                                                </select>
            ...
            $('#submit_id').click(function () {
                ...
                if(value1 == undefined || value2 == '' || value3 == '' || value4 == '' || value5 == undefined  || value7 == '' || value8 == '' || value9 == '' || value10 == undefined || value11 == '' || value12 == '' || value13 == undefined || value14 == '' || value15 == undefined || value16 == undefined || value17 == undefined || value18 == '' || value19 == '' || value20 == '' || value21 == undefined || value22 == undefined || value23 == undefined || value24 == undefined || value25 == '0' || value26 == '0' || value27 == '0' || value28 == '0' || value29 == '0' || value30 == '0' || value31 == '0'){
                    $('#multiple-one_one').modal('show');
                        ...
                        if(value9 == ''){
                            $('#value9').text('Please fill the field');
                        }else{
                            $('#value9').text('');
                        }
