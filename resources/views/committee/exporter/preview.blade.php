                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ul class="breadcrumb m-0">
                            ...
                            <?php if($url_key == 1){
                                    $url = 'committee/exporter';
                                    }
                                    else if($url_key == 2){
                                     $url = 'committee/reject-export';
                                    }else if($url_key == 3){
                                    $url = 'committee/approve-export';
                                    }
                                    ?>
                                ...
                                <!-- <button class="btn btn-primary float-end">
                                <a class="float-end text-white" href="{{ url('committee/exporter') }}" style="font-weight:600;">Back to
                                    Lists</a>
                            </button></li> -->
                        </ul>
                    </div>
