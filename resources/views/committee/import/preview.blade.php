...
@section('content')
    <section class="py-2">
        <div class="container">
            <p class="text-start" style="font-size: 17px; font-weight:600; color:#14468C"><strong>Preview of the Application form for IMPORT
                    of human samples &
                    other biological materials for commercial/contract research </strong><button
                    class="btn btn-primary float-end">
                    <a class="float-end text-white" href="{{ url('committee/import') }}" style="font-weight:600;">Back to
                        Lists</a>
                </button></p>
                        ...
                        <div class="tab-pane show active" id="input-types-preview">
                            <form method="POST" action="{{ url('imp-exp/creates') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="company_denied_import" id="text_yes" value="yes" {{($Imports->company_denied_import != '')? 'checked':''}} disabled/>
                                                        <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                    </div>

                                                    <div class="form-check form-check-inline custom-no">
                                                        <input class="form-check-input" type="radio"
                                                            name="company_denied_import[]" id="text_no" value="no" {{($Imports->company_denied_import == '')? 'checked':''}} disabled/>
                                                        <label class="form-check-label" for="inlineRadio2">No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group wirtetext_yes" style="{{($Imports->denied_import_upload != '')? '':'display: none;'}}">
                                            <a href="/public/media/import/{{ $Imports->denied_import_upload }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        </a>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-3">
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                value="yes" {{ ($Imports->repeat_import != '')? 'checked':''; }} disabled/>
                                                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                        </div>
                                                        ...
                                                        <div class="form-check form-check-inline custom-no">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                value="no" {{ ($Imports->repeat_import == '')? 'checked':''; }} disabled/>
                                                            <label class="form-check-label" for="inlineRadio2">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        <label for="natural_biomateria_exported" class="form-label wirteenvisaged_yes" style="{{ ($Imports->repeat_import != '')? '':'display:none'; }}"><span><strong>Provide details</strong></span></label>
                                                        <textarea name="repeat_import[]" class="wirteenvisaged_yes" id="wirteenvisaged_yes" maxlength="100" cols="30" rows="2"
                                                            max="100" placeholder="Description of items" style="border:1px solid #ddd; border-radius: 5px !important; {{ ($Imports->repeat_import != '')? '':'display:none'; }}">{{ $Imports->repeat_import }}</textarea>
                                                    </div>
                                                </div>
                                           </div>
                                            </div>
                                 ...
                                 @php
                                    $b = explode(",", $Imports->purpose_end_use);
                                    @endphp
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mt-2">
                                            <label for="" class="form-label"><strong>(i) Specify purpose/end use</strong></label>
                                                <!--<div class="arrow-icon py-2 mr-3">
                                                    ...
                                                    {{-- <select name="purpose_end_use[]" id="purposend multiple-select-field" class="form-control form-select" data-placeholder="Please Select" aria-label=".form-select-lg example" multiple> --}}
                                                        ...
                                                        <option class="enduser" value="Calibration/Quality assurance" {{(in_array("Calibration/Quality assurance", $b))? 'selected':''}} class="p-1">
                                                            Calibration/Quality assurance</option>
                                                        <option class="enduser" value="Clinical Diagnostics/Testing" {{(in_array("Clinical Diagnostics/Testing", $b))? 'selected':''}} class="p-1"
                                                            name="">Clinical Diagnostics/Testing</option>
                                                            <option id="purposeend" value="other" {{(in_array("other", $b))? 'selected':''}} class="p-1">other
                                                                (Please sepcify)
                                                            </option>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea name="biosafety_infectious[]" class="infectiousBox" id="infectiousBox" class="infectiousBox" maxlength="100" cols="45" rows="2"max="100" placeholder="Description of items" style="border:1px solid #ddd; border-radius: 5px !important; {{ ($Imports->biosafety_infectious == 'yes')? '':'display:none;' }};">{{ $Imports->biosafety_infectious_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea name="biosafety_materials[]" class="materialsText_yes" id="materialsText_yes" maxlength="100" cols="45" rows="2"
                                                    max="100" placeholder="Description of items" style="border:1px solid #ddd; border-radius: 5px !important; {{ ($Imports->biosafety_materials == 'yes')? '':'display:none;' }}">{{ $Imports->biosafety_materials_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea name="biosafety_vectors[]" class="vectorsText_yes" id="vectorsText_yes" maxlength="100" cols="45" rows="2"
                                                    max="100" placeholder="Description of items" style="border:1px solid #ddd; border-radius: 5px !important; {{ ($Imports->biosafety_vectors == 'yes')? '':'display:none;' }}">{{ $Imports->biosafety_vectors_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea name="biosafety_nucleic[]" class="nucleicText_yes" id="nucleicText_yes" maxlength="100" cols="45" rows="2"
                                                    max="100" placeholder="Description of item" style="border:1px solid #ddd; border-radius: 5px !important; {{ ($Imports->biosafety_nucleic == 'yes')? '':'display:none;' }};">{{ $Imports->biosafety_nucleic_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mt-2">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    value="yes" {{ ($Imports->biological_material != '')? 'checked':'' }} disabled/>
                                                <label class="form-check-label" for="inlineRadio1">Yes</label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline custom-no">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    value="no" {{ ($Imports->biological_material == '')? 'checked':'' }} disabled/>
                                                <label class="form-check-label" for="inlineRadio2">No</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="{{ ($Imports->biological_material != '')? '':'display:none;' }}" id="ibsc_approval_yes">
                                         <a href="/public/media/import/{{ $Imports->biological_material }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        </a>
                                        </div>
                                    </div>
                               </div>
                    ...
                    <div class="row" style="margin: 3px;">
                        ...
                        <div class="col-md-7">
                            <p style="text-align: justify">I certify that the information provided in this
                                ...
                                utilized for the
                                purpose of <input type="text" class="partc" style="float:none;" readonly value="{{ $Imports->purpose_end_use }}">
                            ...
                            <p style="text-align: justify">This is to certify that the samples referred to
                                ...
                                utilized for the purpose of <input type="text" class="" style="float:none;"
                                 readonly   value="{{ $Imports->purpose_end_use }}"> only,
