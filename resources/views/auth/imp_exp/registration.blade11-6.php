                    ...
                    <form method="POST" action="{{ route('sample.validate_registration') }}">
                        @csrf
                            ...
                            {{-- {{ App\Models\ImpExpUse::getIecCodeById(1) }} --}}
                                <div class="form-group">
                                    ...
                                    <input id="iec_code" type="text" class="form-control iec_code @error('iec_code') is-invalid @enderror" name="iec_code" value="{{ old('iec_code') }}" required autocomplete="iec_code" autofocus maxlength="10"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" readonly name="name" value="{{ old('name') }}" required autocomplete="name" required/>
                                    @if($errors->has('name'))
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<input id="department" type="text" class="form-control @error('department') is-invalid @enderror" name="department" value="{{ old('department') }}" required autocomplete="department" onkeypress="return isAlfa(event)"/>
									...
									<div class="form-group">
										...
										<input id="designation" type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" value="{{ old('designation') }}" required autocomplete="designation" onkeypress="return isAlfa(event)"/>
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" required readonly/>
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="address2" type="text" class="form-control @error('address2') is-invalid @enderror" name="address2" value="{{ old('address2') }}" required autocomplete="address2" required readonly/>
                        ...
                        <div class="form-group">
                            ...
                            <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" required autocomplete="city" required readonly readonly/>
						...
						<div class="form-group">
                            ...
                            <input id="states" type="text" class="form-control @error('states') is-invalid @enderror" name="states" value="{{ old('states') }}" required autocomplete="states" required readonly/>
						...
						<div class="row">
						  <div class="col-md-6">
							<div class="form-group">
									...
									<input id="pincode" type="text" class="form-control @error('pincode') is-invalid @enderror" name="pincode" value="{{ old('pincode') }}" required autocomplete="pincode" required readonly/>
					  ...
					  <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group group-input">
                                <input id="mobile_number" type="text" maxlength="10" class="form-control @error('mobile_number') is-invalid @enderror" name="mobile_number" readonly required pattern="[6789][0-9]{9}"/>
