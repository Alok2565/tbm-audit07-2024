            ...
            <div class="col-12">
                <div class="codex-authbox mt-4 mb-4">
				   ...
				   <p class="alert alert-danger">{{ Session::get('msg') }}</p>
                    @endif --}}
                    <form method="POST" action="{{ route('impexp.submitForgetPassword') }}">
                        @csrf
                        <div class="form-group">
                            <label for="emailaddress" class="form-label">{{ __('Iec Code') }}<span class="text-danger">*</span></label>
                            <input type="text" name="iec_code" class="form-control" autocomplete="off" id="iec_code" placeholder="Enter Iec Code" autocomplete="off"/>
