            ...
            <div class="col-12">
                <div class="codex-authbox mt-4 mb-4">
				   ...
				   <p class="alert alert-danger">{{ Session::get('msg') }}</p>
                    @endif --}}
                    <form method="POST" action="{{ route('icmr.icmrsubmitResetPassword') }}">
                        @csrf
                          {{-- <input type="hidden" name="token" value="{{ $token }}"> --}}

                          <div class="form-group">
                            <label for="emailaddress" class="form-label">{{ __('Email address') }}<span class="text-danger">*</span></label>
                            <input type="text" id="email_address" class="form-control" name="email" value="{{$email}}" autocomplete="off" required autofocus placeholder="Email" readonly>
                                  @if ($errors->has('email'))
                          ...
                          <div class="form-group">
                              ...
                              <input type="password" id="password" class="form-control" autocomplete="off" name="password" required autofocus placeholder="Password">
                          ...
                          <div class="form-group">
                              ...
                              <input type="password" id="confirm_password" autocomplete="off" class="form-control" name="confirm_password" required autofocus placeholder="Confirm Password">
