        ...
        <div class="row">
          <div class="col-12">
            <div class="codex-authbox register mt-4 mb-4">
              ...
              <form method="POST" action="{{ route('committee.save-password') }}">
                @csrf
                <div class="form-group">
                    <label class="form-label">{{ __('Email Id') }}</label>
                    <input id="email" type="text" class="form-control iec_code @error('email') is-invalid @enderror" name="email" value="{{ $email }}" required autocomplete="off" autofocus readonly>
                    @if($errors->has('email'))
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group group-input">
                      <input class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="off" type="password" id="password" placeholder="Enter Your Password" required=""><span class="input-group-text toggle-show fa fa-eye"></span>
