          ...
          <div class="col-12">
            ...
            <div class="codex-authbox register mt-4 mb-4">
              <div class="auth-header">
                ...
                <h3 class="justify-content-between text-center" style="color: #000;text-transform:initial !important;">Registration form for Committee Members</h3>
                </div>
              <form method="POST" action="{{ route('committee.validate_registration') }}">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="off"></textarea>
				...
				<div class="form-group">
                 ...
                 <div class="form-group">
                            ...
                            <div class="input-group group-input">
                                <input id="mobile_number" type="text" maxlength="10" class="form-control @error('mobile_number') is-invalid @enderror" name="mobile_number" required pattern="[6789][0-9]{9}" autocomplete="off"/>
                                @if($errors->has('mobile_number'))
                                <span class="text-danger">{{ $errors->mobile_number('mobile_number') }}</span>
                                @endif
                            </div>
                 </div>
                <!-- <div class="form-group">
                ...
                {{-- <h6 class="mt-2" style="color: #8392a5;">Already have an account? <a class="text-primary" href="{{route('committee.login')}}">login in here</a></h6> --}} -->
                <div class="form-group">
