            ...
            <div class="col-12">
                <div class="codex-authbox mt-4 mb-4">
                    <div class="auth-header">
                        ...
                        <h5 class="justify-content-between" style="color: #000; font-weight:600;">Login for ICMR
                            Committee</h5>
                    </div>
                    @if(Session::has('msg'))
                    <p class="alert alert-danger">{{ Session::get('msg') }}</p>
                    @endif
                    <form method="POST" action="{{ url('committee/signin') }}">
                        @csrf
					...
					<!--<span class="float-end"><a href="#">Forgot Your Password</a></span>-->
