                ...
                <div class="card-body">
                    ...
                    <div class="card-content-item" style="line-height: 2em; margin-top: 10px;">
                        <p style="text-align: justify;">
                            This is to certify that <strong>{{$results->sending_applicant_name}}</strong>, <strong>{{$results->sending_add_company_institute}}</strong> (Name of the applicant and company)
                            ...
                            the Samples) to <strong>{{$results->receving_recipient_name}}</strong>, <strong>{{$results->receving_recipient_design}}</strong> (Name and Company of recipient) in <strong>{{$results->receiving_add_company_institute}}</strong> (Country of Destination) for the purpose of <strong>{{$results->sample_collected}}</strong> (Description of the type(s) of investigations or analyses to be conducted on the samples). This approval is valid for a period of 90 (Ninety) days with effect from the date of authorization.
                        </p>
                    </div>
                </div>
                <div class="card-body">
