                                        ...
                                        <tbody>
                                            @foreach ($dataExporters as $key => $dataExport)
                                                <tr>
                                                   ...
                                                   <td>
                                                        <?php if($dataExport->comm_status =='Approve') { ?>
                                                        
                                                        <a class="btn btn-warning" href="javascript:void(0)"
														data-url="{{ url('icmr/exporter/status', $dataExport->id) }}" onclick="return confirm('Reject Reason:- {{ $dataExport->comments }}');">Complete</a>
														<?php }?>
