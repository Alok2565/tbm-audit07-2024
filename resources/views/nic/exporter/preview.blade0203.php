...
@section('title', 'Preview Exporter Application')
@section('content')
        ...
        <div class="row">
            ...
            <!-- <div class="container">
                <p class="text-start" style="font-size: 17px; font-weight:600; color:#14468C"><strong>Preview Of The Application form for Export of Human Biological Material</strong><button class="btn btn-primary float-end">
                        <a class="float-end text-white" href="{{ url('imp-exp/exporter') }}" style="font-weight:600;">Back to
                            Lists</a>
                    </button>
                </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control select2-multiple" data-toggle="select2"
                                            ...
                                            <option class="multiple_biom" value="whole blood" class="p-1" {{(in_array("whole blood", $a))? 'selected':''}}>
                                                Whole blood</option>
                                                <option class="multiple_biom" value="buffy coat" class="p-1" {{(in_array("buffy coat", $a))? 'selected':''}}>
                                                    Buffy coat</option>
                                            ...
                                            <option class="multiple_biom" value="urine" class="p-1"
                                                ...
                                                <option class="multiple_biom" value="nucleic acid" class="p-1" {{(in_array("nucleic acid", $a))? 'selected':''}}>Nucleic acid</option>
                                                <option class="multiple_biom" value="extracted dna" class="p-1" {{(in_array("extracted dna", $a))? 'selected':''}}>Extracted DNA</option>
                                                <option class="multiple_biom" value="extracted rna" class="p-1" {{(in_array("extracted rna", $a))? 'selected':''}}>Extracted RNA</option>
                                    ...
                                    <div class="form-group mt-2">
                                        <label for="sample_collected" class="form-label"><strong>(iii) Where the samples collected?</strong></label>
                                            {{-- <select name="sample_collected[]" id="multiple_custom_list" class="form-control form-select multiple_custom_list custom_list" id="multiple-select-field" data-placeholder="Seletc one or more..." multiple> --}}
                                                <select class="select2 form-control select2-multiple" data-toggle="select2" multiple="multiple" data-placeholder="Select..." disabled>
                                                <option value="Inpatient hospital facility"  class="sample_collected_option" {{(in_array("Inpatient hospital facility", $b))? 'selected':''}}>Inpatient hospital facility</option>
                                                <option value="Outpatient hospital facility"  class="sample_collected_option" {{(in_array("Outpatient hospital facility", $b))? 'selected':''}}>Outpatient hospital facility</option>
                                                <option value="Clinical/ Diagnostic laboratory"  class="sample_collected_option" {{(in_array("Clinical/ Diagnostic laboratory", $b))? 'selected':''}}>Clinical/ Diagnostic laboratory</option>
                                                <option value="Research laboratory"  class="sample_collected_option" {{(in_array("Research laboratory", $b))? 'selected':''}}>Research laboratory</option>
                                                <option value="other"  id="otherSample" {{(in_array("other", $b))? 'selected':''}}>Other (Please sepcify)</option>
                                            </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mt-2">
                                        ...
                                        <select name="purpose_sample_store[]" id="purpose_sample_store" multiple class="form-control form-select mt-1" aria-label=".form-select-lg example" disabled>
                                            <option value="" class="text-muted" style="font-weight: 600;"><strong></strong>
                                            </option>
                                           ...
                                           <textarea name="purpose_sample_store" class="wirteotherFurther" id="wirteotherFurther" class="mt-2" maxlength="100" cols="60" rows="2" max="100" placeholder="Description of items" style="display:none; border:1px solid #ddd; border-radius: 5px !important;" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"  value="Yes" {{ ($export_data->biomaterial_micro_organisms_approval == 'Yes')? 'checked':''; }} disabled>
                                            <label class="form-check-label" for="inlineRadio1">Yes</label><br />
                                        </div>
                                        ...
                                        <div class="input-group" style="width:50%"><a href="{{ asset('media/exporter/'.$export_data->biomaterial_micro_organisms_approval_file) }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        </a>
                                        </div>
                                        ...
                                        @enderror
                                        <div class="form-check custom-no">
                                            <input class="form-check-input" type="radio" name="biomaterial_micro_organisms_approval" id="biomaterial_no" value="No"  disabled/>
                                            <label class="form-check-label" for="inlineRadio2">No</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="biomaterial_micro_organisms_approval" id="ibscRcgm_yes" value="Yes" {{ ($export_data->ibsc_rcgm_approval_applicable == 'Yes')? 'checked':''; }} disabled>
                                            <label class="form-check-label" for="inlineRadio1">Yes</label><br />
                                        </div>
                                        ...
                                        <div class="input-group" style="width:50%">
                                            <input type="file" name="ibsc_rcgm_approval_applicable" class="form-control ibscRcgmText" id="ibscRcgmText" style="display:none;">
                                            <a href="{{ asset('media/exporter/'.$export_data->ibsc_rcgm_approval_applicable_file) }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        </a>
                                        </div>
                                        @error('ibsc_rcgm_approval_applicable')
                                        <div class="alert alert-danger" role="alert">{{$message}}</div>
                                        @enderror
                                        <div class="form-check custom-no">
                                            <input class="form-check-input" type="radio" name="ibsc_rcgm_approval_applicable" id="ibscRcgmText" value="No" {{ ($export_data->ibsc_rcgm_approval_applicable == 'No')? 'checked':''; }} disabled>
                                            <label class="form-check-label" for="inlineRadio2">No</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="m-2">I certify that the information provided in this request form is true and
                                        ...
                                        referred to herein will be utilized for the purpose of <br>&nbsp;<input class="form-control costum1" type="text" readonly id="declaration_of_purpose" name="sender_certify_information_provided" value="{{ ($export_data->specify_purpose_end_use != '')? $export_data->specify_purpose_end_use:''}}"><span>only, the sample will not be used for any other purposes.</span></label>
                                    ...
                                    <p class="p-2">(Authorized signatory on behalf of
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group mb-3 m-2">
                                                ...
                                                <a href="{{ asset('media/exporter/'.$export_data->certified_copy_proforma) }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        </a>
                                            </div>
                                        </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-5">
                                            <div class="form-group mb-3 m-2">
                                                ...
                                                <a href="{{ asset('media/exporter/'.$export_data->declaration_letter) }}" target="_blank"><label class="form-lable"><strong>View Uploaded documents</strong></label>
                                                        </a>
                                            </div>
