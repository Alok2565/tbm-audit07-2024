                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mt-2">
                                        <label for="sample_collected" class="form-label"><strong>(iii) Where the samples collected?</strong></label><br>
                                        <ul>
                                        @php 
                                        if(!empty($b)){
                                            foreach($b as $value2){
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="" class="form-label">Volume</label><br>
                                                {{ $export_data->exported_volume }}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="m-2">I certify that the information provided in this request form is true and
                                        ...
                                        referred to herein will be utilized for the purpose of <br>&nbsp;<input class="form-control costum1" type="text" readonly id="declaration_of_purpose" name="sender_certify_information_provided" value="{{ ($export_data->sender_certify_information_provided != '')? $export_data->sender_certify_information_provided:''}}"><span>only, the sample will not be used for any other purposes.</span></label>
