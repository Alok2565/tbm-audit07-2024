    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            <li class="side-nav-item">
                <a href="{{ url('nic/dashboard') }}" class="side-nav-link">
                    <i class="uil uil-dashboard"></i>
                    <span> Dashboards </span>
                </a>
            </li>
            {{-- <li class="side-nav-item">
                <a href="{{ URL('nic/import') }}" class="side-nav-link">
            ...
            <!--<li class="side-nav-item">
                ...
                <div class="collapse" id="Export">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{url('nic/exporter')}}"><i class="mdi mdi-application-export"></i> Fresh Application Received for Comments</a>
                        </li>
						<li>
                            <a href="{{url('nic/reject-export')}}"><i class="mdi mdi-application-export"></i> Applications with Decision</a>
                        </li>
						<li>
                            <a href="{{url('nic/approve-export')}}"><i class="mdi mdi-application-export"></i> Approve Applications</a>
                        </li>
                    </ul>
                </div>
            </li>-->
            <li class="side-nav-item">
                <a href="{{ url('nic/user-list') }}" class="side-nav-link">
                    <i class="mdi mdi-application-export"></i>
                    <span>Total Exporters Registered</span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="{{ url('nic/exporter') }}" class="side-nav-link">
                    <i class="mdi mdi-application-export"></i>
