...
<html lang="en">
    ...
    <body>
        <!-- Begin page -->
        <div class="wrapper">
            @include('nic.layouts.top_right')
            @include('nic.layouts.sidebar_nav')
...
<!-- Code Highlight js -->
<script src="{{ asset('public/assets/vendor/highlightjs/highlight.pack.min.js') }}"></script>
<script src="{{ asset('public/assets/vendor/clipboard/clipboard.min.js') }}"></script>
