...
@section('content')
    <div class="page-title-box">
        <h3 class="text-dark">ICMR Dashboard</h3>
        <div class="card">
            <div class="card-body">
        {{-- <div class="row">
                    ...
                    <div style="background-color: #688A22;border-radius: 10px;" class="card-body">
                        <div class="row align-items-center">
                            <div class="col-12">
                                ...
                                <a href="{{url('icmr/import')}}"><span class="text-white me-2"><i class="mdi mdi-arrow-right-bold"></i>More Info</span></a>
                                </p>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12">
                                <h5 class="text-white fw-normal mt-0 text-truncate" title="Campaign Sent"><b>
                                        Fresh Applications Received</b></h5>
                                <h3 class="my-2 py-1 text-white"> {{$totalExporter}}  <span class="text-success float-end me-2"><i
                                            style="font-size:35px;" class="ri-file-list-fill text-white"></i></span></h3>
                                <p class="mb-0 text-left">
                                <a href="{{url('icmr/exporter')}}"><span class="text-white me-2"><i class="mdi mdi-arrow-right-bold"></i>More Info</span></a>
                                </p>
                            </div>
                    ...
                    <div class="card-body" style="background-color: #67707F; border-radius: 10px;">
                        <div class="row align-items-center">
                            <div class="col-12">
                                        ...
                                        Applications reverted back to<br> Applicant</b></h5>
                                <h3 class="text-white"> {{$pendingExporter}} <span class="text-success float-end"><i
                                            style="font-size:35px;" class="ri-file-edit-fill text-white"></i></span></h3>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12">
                                <h5 class="text-white fw-normal mt-0 text-truncate" title="Deals"><b>
                                        Applications with<br> Committee Member</b></h5>
                                <h3 class="my-2 text-white"> {{$assigncommiteeExporter}} <span class="text-success float-end me-2"><i
                                            style="font-size:35px;" class="ri-file-excel-fill text-white"></i></span></h3>
                                <p class="mb-0 text-left">
                                    <a href="{{url('icmr/assign-committee-export')}}"><span class="text-white me-2"><i class="mdi mdi-arrow-right-bold"></i>More Info</span></a>
                                </p>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12">
                                ...
                                <h3 class="my-2 py-1 text-white"> {{$totalNocIssued}} <span class="text-success float-end me-2"><i
                                            style="font-size:35px;" class="ri-file-edit-fill text-white"></i></span></h3>
                                <p class="mb-0 text-left">
                                    <a href="{{url('icmr/exportList-noc')}}"><span class="text-white me-2"><i class="mdi mdi-arrow-right-bold"></i>More Info</span></a>
                                </p>
                            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body" style="background-color: #D12E00; border-radius: 10px;">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <h5 class="text-white fw-normal mt-0 text-truncate" title="Deals"><b>Applications denied NOC</b></h5>
                                <h3 class="my-2 py-1 text-white"> {{$rejectExporter}} <span class="text-success float-end me-2"><i
                                            style="font-size:35px;" class="ri-file-excel-fill text-white"></i></span></h3>
                                <p class="mb-0 text-left">
                                    <a href="{{url('icmr/reject-export')}}"><span class="text-white me-2"><i class="mdi mdi-arrow-right-bold"></i>More Info</span></a>
                                </p>
                            </div>
