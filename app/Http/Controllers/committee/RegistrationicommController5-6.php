...
class RegistrationicommController extends Controller
{
   ...
   public function registrationcommittee()
    ...
    public function signincommittee(Request $request)
    {
		...
		if($result){
           ...
           //echo "aaav"; die;
			 ...
			 return redirect('committee/email-verification');
			  return redirect()->route('comm.SubmitEmailVericationComm');
            }else{
				//echo "bbb"; die;
    ...
    public function SubmitemailVericationComm(Request $request)
    {
    ...
    public function sendEmailVericationFormComm(Request $request)
    {
         $request->validate([
            'email_otp' => 'required',
            'captcha' => 'required|captcha',
		...
		//dd('done');
            ...
            return redirect()->route('comm.SubmitEmailVericationComm')->with('msg','Please enter valid OTP');
        }
    }
   ...
   public function logoutcommittee(Request $request){
    ...
    public function commSubmitForgetPassword(Request $request)
    {
        ...
        Mail::to($user->email)->cc('alok.icmr@yopmail.com')->send(new EmailForgotPasswordComm($forgotcommEmailLink, ['remember_token' => $token]));
    ...
    public function commShowResetPwdForm()
    {
        return view('auth.committee.reset_password');
    }
